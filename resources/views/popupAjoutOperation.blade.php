...
<div class="modal fade in operation" id="modalAjoutOperation" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header jumbotron titreAffectation">
                <h4> Ajout operation</h4>
				<button type="button" class="close" data-dismiss="modal" >
					<span aria-hidden="true">&times;</span>
				</button>
			</div>

            <form id="formAjouteOperation" class="form-horizontal" action="/ajoutOperation" method="post">
                @csrf
